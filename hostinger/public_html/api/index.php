...
$routes = [
    ...
    ['GET',    '#^/solicitudes/mis-atenciones-ops$#',              'solicitudes/mis_atenciones_ops'],
    ...
    // Portal de Pagos — traslado de fondos
    ['GET',    '#^/pagos/empresas$#',                            'pagos/empresas_listar'],
    ['POST',   '#^/pagos/empresas$#',                            'pagos/empresas_crear'],
    ['PATCH',  '#^/pagos/empresas/(?P<id>\d+)$#',                'pagos/empresas_actualizar'],
    ['GET',    '#^/pagos/bancos$#',                              'pagos/bancos_listar'],
    ['POST',   '#^/pagos/bancos$#',                              'pagos/bancos_crear'],
    ['PATCH',  '#^/pagos/bancos/(?P<codigo>\d+)$#',              'pagos/bancos_actualizar'],
    ['DELETE', '#^/pagos/bancos/(?P<codigo>\d+)$#',              'pagos/bancos_eliminar'],
    ['GET',    '#^/pagos/plantilla$#',                           'pagos/plantilla_csv'],
    ['GET',    '#^/pagos/auditoria$#',                           'pagos/auditoria'],
    ['GET',    '#^/pagos/lotes$#',                               'pagos/lotes_listar'],
    ['POST',   '#^/pagos/lotes$#',                               'pagos/lotes_crear'],
    ['GET',    '#^/pagos/lotes/(?P<id>\d+)$#',                   'pagos/lote_obtener'],
    ['DELETE', '#^/pagos/lotes/(?P<id>\d+)$#',                   'pagos/lote_eliminar'],
    ['PUT',    '#^/pagos/lotes/(?P<id>\d+)/pagos$#',             'pagos/lote_pagos_guardar'],
    ['POST',   '#^/pagos/lotes/(?P<id>\d+)/importar$#',          'pagos/lote_importar'],
    ['POST',   '#^/pagos/lotes/(?P<id>\d+)/validar$#',           'pagos/lote_validar'],
    ['POST',   '#^/pagos/lotes/(?P<id>\d+)/generar$#',           'pagos/lote_generar'],
    ['POST',   '#^/pagos/lotes/(?P<id>\d+)/empaquetar$#',        'pagos/lote_empaquetar'],
    ['GET',    '#^/pagos/lotes/(?P<id>\d+)/clave$#',             'pagos/lote_clave'],
    ['GET',    '#^/pagos/lotes/(?P<id>\d+)/descargar$#',         'pagos/lote_descargar'],
    ['POST',   '#^/pagos/lotes/(?P<id>\d+)/correo$#',            'pagos/lote_correo'],
    ['POST',   '#^/pagos/lotes/(?P<id>\d+)/anular$#',            'pagos/lote_anular'],
    ['POST',   '#^/pagos/lotes/(?P<id>\d+)/reabrir$#',           'pagos/lote_reabrir'],
